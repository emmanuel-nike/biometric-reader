...
public class BluetoothReaderService {
    ...
    //private static BluetoothReaderService singleInstance = null;
...
//    public static synchronized BluetoothReaderService getInstance(Handler handler)
//    {
//        if (singleInstance == null)
//            singleInstance = new BluetoothReaderService(handler);
//        singleInstance.mHandler = handler;
...
//        if (Build.VERSION_CODES.S == Build.VERSION.SDK_INT && ActivityCompat.checkSelfPermission(context, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
//            return;
//        }
